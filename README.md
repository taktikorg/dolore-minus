[![npm](https://img.shields.io/npm/v/@taktikorg/dolore-minus.svg)](https://www.npmjs.com/package/@taktikorg/dolore-minus) ![downloads](https://img.shields.io/npm/dt/@taktikorg/dolore-minus.svg) [![CI](https://github.com/taktikorg/dolore-minus/actions/workflows/ci.yml/badge.svg)](https://github.com/taktikorg/dolore-minus/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@taktikorg/dolore-minus/renderer](https://www.npmjs.com/package/@@taktikorg/dolore-minus/renderer).

## tl;dr

- Install by executing `npm install @taktikorg/dolore-minus` or `yarn add @taktikorg/dolore-minus`.
- Import by adding `import { Document } from '@taktikorg/dolore-minus'`.
...
[Online demo](https://projects.wojtekmaj.pl/@taktikorg/dolore-minus/) is also available!
...
- [v7.x](https://github.com/taktikorg/dolore-minus/blob/v7.x/packages/@taktikorg/dolore-minus/README.md)
- [v6.x](https://github.com/taktikorg/dolore-minus/blob/v6.x/README.md)
- [v5.x](https://github.com/taktikorg/dolore-minus/blob/v5.x/README.md)
- [v4.x](https://github.com/taktikorg/dolore-minus/blob/v4.x/README.md)
- [v3.x](https://github.com/taktikorg/dolore-minus/blob/v3.x/README.md)
- [v2.x](https://github.com/taktikorg/dolore-minus/blob/v2.x/README.md)
- [v1.x](https://github.com/taktikorg/dolore-minus/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @taktikorg/dolore-minus` or `yarn add @taktikorg/dolore-minus`.
...
```ts
import { pdfjs } from '@taktikorg/dolore-minus';
...
import { Document, Page } from '@taktikorg/dolore-minus';
...
Check the [sample directory](https://github.com/taktikorg/dolore-minus/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/taktikorg/dolore-minus/wiki/Recipes) in [React-PDF Wiki](https://github.com/taktikorg/dolore-minus/wiki/).
...
```ts
import '@taktikorg/dolore-minus/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@taktikorg/dolore-minus/dist/Page/TextLayer.css';
```
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@taktikorg/dolore-minus__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@taktikorg/dolore-minus__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@taktikorg/dolore-minus__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@taktikorg/dolore-minus__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/taktikorg/dolore-minus/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@taktikorg/dolore-minus-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/dolore-minus-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@taktikorg/dolore-minus-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@taktikorg/dolore-minus-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/dolore-minus-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@taktikorg/dolore-minus-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@taktikorg/dolore-minus/contributors.svg?width=890&button=false)
